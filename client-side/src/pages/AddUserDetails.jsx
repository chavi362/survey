...
//       console.log(user);
//       const response = await serverRequests('PUT', `users/${user.userCode}`, updatedFormUser);
//       if (response.error) {
    ...
    <section className="form-container">
      <div className="form-card">
        <div className="form-header">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/lotus.webp" alt="logo" className="form-logo" />
        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="ageID">Age Range</label>
              <select
                id="ageID"
                className="form-control"
                value={formUser.ageID}
            ...
            <div className="form-group">
              <label htmlFor="incomeID">Income Level</label>
              <select
                id="incomeID"
                className="form-control"
                value={formUser.incomeID}
